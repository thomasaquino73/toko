<ul>
	...
	<li class="submenu">
		...
		<ul style="display: none;">
			<li <?php if ($this->uri->segment(2) == "daftar-barang") {
					...
					echo 'class=" "';
				} ?>><a href="<?= base_url('barang/daftar-barang') ?>">Daftar Barang</a></li>
			...
			<li <?php if ($this->uri->segment(2) == "kategori") {
					...
					echo 'class=" "';
				} ?>><a href="<?= base_url() ?>barang/kategori">Kategori</a></li>
		</ul>
	</li>
	<li class="menu-title">Transaksi</li>
	<li <?php if ($this->uri->segment(1) == "pembelian") {
			echo 'class="active"';
		} else {
			echo 'class=" "';
		} ?>>
	...
	<li <?php if ($this->uri->segment(2) == "stok") {
			echo 'class="active"';
		} else {
			echo 'class=" "';
		} ?>>
		<a href="<?= base_url() ?>laporan/stok"><i class="fa fa-users"></i> <span>Stok</span></a>
	</li>
	<li>
