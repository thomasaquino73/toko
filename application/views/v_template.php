...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/themes/alertify.core.css" />
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/themes/alertify.default.css" id="toggleCSS" />
        ...
        <div class="header">
            <div class="header-left">
                <a href="<?= base_url() ?>" class="logo">
                    <!-- <img src="<?= base_url() ?>assets/img/logo.png" width="35" height="35" alt=""> <span>Preclinic</span> -->
                    <img src="<?= base_url('assets/logo/') . $konfigurasi->logo ?>" width="65" height="35" alt="">
                    <span style="font-color:#000;text-transform:uppercase;"><?= $konfigurasi->namaPerusahaan ?></span>
                </a>
            </div>
   ...
   <option value="indo" <?php if ($this->session->userdata('site_lang') == 'indo') echo 'selected="selected"'; ?>>INDONESIA</option>
                ...
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="<?= base_url('pengaturan/ganti-password') ?>">Ganti Password</a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <?php if ($this->uri->segment(1) == "pengaturan") {
                        include_once "menu_pengaturan.php";
                    } else {
    ...
    <!-- <script type="text/javascript" src="<?= base_url('') ?>js/jquery.toast.js"></script> -->
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js" integrity="sha384-oBqDVmMz9ATKxIep9tiCxS/Z9fNfEXiDAYTujMAeBAsjFuCZSmKbSSUnQlmh/jp3" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.min.js" integrity="sha384-mQ93GR66B00ZXjt0YO5KlohRA5SY2XofN4zfuZxLkoj1gXtW8ANNCe9d5Y3eG5eD" crossorigin="anonymous"></script>
    ...
    <script src="<?= base_url() ?>assets/js/jquery.chained.js" type="text/javascript" charset="utf-8"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.selectprovinsi').select2({
                dropdownParent: $("#modal_kota")
            });
            $('.selectkota').select2({
                dropdownParent: $("#modal_kecamatan")
            });
            $('.selectkecamatan').select2({
                dropdownParent: $("#modal_kelurahan")
