<div class="row">
	<div class="col-sm-4 col-3">
		<h4 class="page-title">Daftar Kategori Barang</h4>
	</div>
	<div class="col-sm-8 col-9 text-right m-b-20">
		<a href="<?= base_url() ?>barang/kategori/add" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Tambah Data</a>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="table-responsive">
			...
			<table id="table" class="display compact " style="width:100%">
				<thead>
					<tr>
						<th style="">#</th>
						<th style="min-width:150px;">Nama Kategori</th>
...
<script>
	...
	jQuery(document).ready(function() {
		table = $('#table').DataTable({
			"ajax": {
				"url": "<?= base_url() ?>barang/kategori/table",
			}
		});
	})
