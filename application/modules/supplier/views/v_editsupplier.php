<div class="row">
    <div class="col-md-8">
        <form action="" method="post">
            <div class="card-box">
                <div class="row">
                    <input type="hidden" name="supplier_id" value="<?= $header->idSupplier ?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" name="namaperusahaan" placeholder="Nama Perusahaan" style="text-transform:uppercase" class="form-control " value="<?= $this->input->post('namaperusahaan') ?? $header->namaperusahaan ?>">
                ...
                <div class="text-right">
                    ...
                    <a href="<?= base_url() ?>master-data/supplier" class="btn btn-danger">Batal</a>
                </div>
            </div>
        </form>
    </div>
